...
def pskimport(filepath,
    ...
    if bImportbone:
        ...
        bone_group_unused = armature_obj.pose.bone_groups.new(name = "DELETE")
        ...
        for psk_bone in psk_bones:
            ...
            if not psk_bone.have_weight_data:
...
def LoadTModelItem(context):
    ...
    if exists(ExportDataPath):
        ...
        bpy.context.window_manager.popup_menu(draw, title="Export Data does not exist", icon='ERROR')
